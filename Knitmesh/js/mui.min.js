...
function() {
	...
	function(a) {
		...
		a.openWindow = function(b, c, f) {
			if (window.plus) {
				...
				if (f.createNew !== !0 && (j = plus.webview.getWebviewById(c))) return g = a.showOptions(f.show), j.show(g.aniShow, g.duration, function() {
					d(j), e(j, "pagebeforeshow", !1)
				}), j;
				...
				_handleSlide: function(b) {
					...
					if (b.target === c.wrapper) {
						...
						if (m) {
							...
							if (n.length > 0)
								for (var g = 0, h = n.length; h > g; g++) n[g].classList[g === d.slideNumber ? "add" : "remove"](j);
							else {
								var o = m.querySelector(".mui-number span");
								if (o) o.innerText = d.slideNumber + 1;
								else
									for (var p = c.wrapper.querySelectorAll(".mui-control-item"), g = 0, h = p.length; h > g; g++) p[g].classList[g === d.slideNumber ? "add" : "remove"](j)
							}
						}
						b.stopPropagation()
					}
		...
		a.fn.slider = function(b) {
			...
			return this.each(function() {
				...
				if (this.classList.contains(c) || (e = this.querySelector("." + c)), e && e.querySelector(k)) {
					...
					f ? (d = a.data[f], d && b && d.refresh(b)) : (f = ++a.uuid, a.data[f] = d = new n(e, b),
	...
	function(a, b, c, d) {
		...
		var o, p = function(a) {},
			q = function(b) {
				this.removeEventListener("webkitTransitionEnd", q), this.addEventListener("touchmove", a.preventDefault), a.trigger(this, "shown", this)
			},
			r = function(b) {
				v(this, "none"), this.removeEventListener("webkitTransitionEnd", r), this.removeEventListener("touchmove", a.preventDefault), p(!1), a.trigger(this, "hidden", this)
			},
			s = function() {
				var b = c.createElement("div");
		...
		var u = function(a, b) {
				...
				if (d && (d.addEventListener("webkitTransitionEnd", r), d.classList.remove(l), a === d)) return void t(d);
				var e = !1;
				(a.classList.contains(i) || a.classList.contains(g)) && (a.classList.contains(g) ? (e = !0, s.classList.add(k)) : s.classList.add(j)), v(a, "block"), a.offsetHeight, a.classList.add(l), s.setAttribute("style", ""), c.body.appendChild(s), p(!0), w(a, b, e), s.classList.add(l), a.addEventListener("webkitTransitionEnd", q)
			},
			v = function(a, b, c, d) {
				var e = a.style;
		...
		a.createMask = function(b) {
			...
			var b = arguments;
			this.each(function() {
				a.targets._popover = this, ("show" === b[0] || "hide" === b[0] || "toggle" === b[0]) && u(this, b[1])
			})
		}
